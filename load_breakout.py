...
def preprocess_frame(frame):
    ...
    frame = frame[::4, ::4]  # Downsample by factor of 4 to 40x40
...
model_filename = 'dqn_breakout_400.keras'  # Name of the model file
...
for episode in range(num_episodes):
    ...
    while True:
        ...
        q_values = trained_model.predict(
            np.expand_dims(stack_frames(state_stack), axis=0))
        ...
        print(
            f"Reward received: {reward}, Done: {done}, Truncated: {truncated}")
